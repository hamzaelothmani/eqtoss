    ...
    <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
      ...
      <div className="pt-12 sm:pt-16 lg:pt-20">
        ...
        <div className="mt-6 text-gray-500 space-y-6">
          <p className="text-lg">EQTOSS.com lists billions of products from thousands of stores, including Amazon, eBay, Walmart, Target, and other retailers! Most sites focus on new products, which are only part of your shopping options. Our comparison shopping site adopts a sustainable approach that elevates the used, refurbished, local, rental, and auction items often overlooked when comparison shopping. Get the best possible online shopping deals with our lowest price finder. Shop informed with EQTOSS.com.</p>
