...
<SiGmail className="w-6 h-6 mr-2" />
  Gmail
          ...
          <div className="mt-10 flex sm:flex-col1">
            <a href={url} rel="noopener noreferrer"  className="max-w-xs flex-1 bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500 sm:w-full" target='_blank' >See The Deal <span className=" ml-2" > <FiExternalLink /></span> </a>
