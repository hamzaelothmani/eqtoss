...
const Infos = () => {
  ...
  // ])
    ...
    console.log(images,"hgjgbgbgbhgb")
useEffect(()=>{
    ...
    <div class="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
      ...
      <div class="flex flex-col-reverse">
        ...
        <div class="w-full aspect-w-1 aspect-h-1">
          ...
          <Image src={`${images[index]}`}  layout='responsive' width={1000} height={800}   objectFit="contain"
            quality={100}  />
          </div>
      ...
      <div class="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
        ...
        <div class="mt-3">
          ...
          <p class="text-2xl text-gray-900 line-through opacity-60">$ {prePrice} </p>
        </div>
