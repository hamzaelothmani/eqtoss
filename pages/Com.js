...
const Com = ({id, text, date, state, ele, name}) => {
  return (
    <>
    <section class="relative flex  break-all items-center justify-center antialiased bg-white  min-w-screen">
    <div class="container  px-0 mx-auto   sm:px-5">
        ...
        <div
            ...
            <div class="flex   flex-row">
                ...
                <div class="flex-col  h-auto mt-1">
                    <div class="flex items-center   flex-1 px-4 font-bold leading-tight">{name}
                        <span class="ml-2 text-xs font-normal text-gray-500"> {date} </span>
                    </div>
                    <div class="flex-1  px-2 ml-2 text-sm font-medium leading-loose text-gray-600">{text}
                    </div>
